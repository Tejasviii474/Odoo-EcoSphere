  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        setScores({
          overall: data.overall_esg_score || 0,
          environmental: data.breakdown.environmental_score || 0,
          social: data.breakdown.social_score || 0,
          governance: data.breakdown.governance_score || 0,
        });
      } catch (err) {
